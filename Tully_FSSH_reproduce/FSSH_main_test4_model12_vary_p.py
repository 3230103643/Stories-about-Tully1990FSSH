...
mass, dt, num_traj = 2000, 10, 300 # mass是质量，dt是时间步长，num_traj是系综轨道数
...
for p0 in p0_values:
    ...
    for trajectory in range(num_traj):
        ...
        #totE_initial = 0.5 * mass * v0 ** 2 + eig[0][0] # 初始总能量 # v0项是核动能，V[0][0]是电子哈密顿量的本征值
    ...
    end_time = time.time()
    print(f"p0: {p0}, TL_prob: {TL/num_traj}, TU_prob: {TU/num_traj}, RL_prob: {RL/num_traj}")
